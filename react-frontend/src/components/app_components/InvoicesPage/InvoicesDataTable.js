    ...
    <>
      ...
      >
        ...
        <Column
          ...
          header="Item"
          body={pTemplate1}
          filter={selectedFilterFields.includes("item")}
          hidden={selectedHideFields?.includes("item")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
          ...
          filter={selectedFilterFields.includes("subTotal")}
          hidden={selectedHideFields?.includes("subTotal")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
