...
const pTemplate0 = (rowData, { rowIndex }) => <p >{rowData.details}</p>
const p_numberTemplate1 = (rowData, { rowIndex }) => <p >{rowData.quantity}</p>
const p_numberTemplate2 = (rowData, { rowIndex }) => <p >{rowData.price}</p>
  ...
  const handleHideDialog = () => {
    ...
    return (
        ...
        />
<Column field="details" header="Details" body={pTemplate0} filter={selectedFilterFields.includes("details")} hidden={selectedHideFields?.includes("details")}  sortable style={{ minWidth: "8rem" }} />
<Column field="quantity" header="Quantity" body={p_numberTemplate1} filter={selectedFilterFields.includes("quantity")} hidden={selectedHideFields?.includes("quantity")}  sortable style={{ minWidth: "8rem" }} />
<Column field="price" header="Price" body={p_numberTemplate2} filter={selectedFilterFields.includes("price")} hidden={selectedHideFields?.includes("price")}  sortable style={{ minWidth: "8rem" }} />
